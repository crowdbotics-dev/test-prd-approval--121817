...
## Project Structure
    ...
    ├── test_prd_approval__121817  # Django project configurations
...
1. Clone this repo and `cd test_prd_approval__121817`
...
2. Clone this repo and `cd test_prd_approval__121817`
