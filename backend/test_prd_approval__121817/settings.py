"""
Django settings for test_prd_approval__121817 project.
...
ROOT_URLCONF = 'test_prd_approval__121817.urls'
...
WSGI_APPLICATION = 'test_prd_approval__121817.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_prd_approval__121817 API",
    "DESCRIPTION": "API documentation for test_prd_approval__121817 App",
    "VERSION": "v1",
}
